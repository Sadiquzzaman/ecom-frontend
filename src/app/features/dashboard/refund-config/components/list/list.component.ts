...
export class ListComponent implements AfterViewInit {
    ...
    merge(this.sort.sortChange, this.paginator.page)
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.refundConfigService.pagination(page, limit, sort, order);
        }),
        map((res) => {
  ...
  edit = (id: string) => {
    this.router.navigateByUrl('/dashboard/refund-config/edit/' + id);
  };
  delete = (id: string) => {
    ...
    this.dialogRef.afterClosed().subscribe((yes) => {
      if (yes) {
        this.refundConfigService.remove(id).subscribe((res) => {
          this.rS.fire(res);
          this.showAll();
        });
      }
