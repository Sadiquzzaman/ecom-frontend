...
@Component({
  selector: 'app-rejected-refund-request',
  templateUrl: './rejected-refund-request.component.html',
  styleUrls: ['./rejected-refund-request.component.scss'],
})
export class RejectedRefundRequestComponent implements AfterViewInit {
  ...
  goToReturnRequestDetails = (refundID: string, assignStatus: number = 5) => {
    // console.log(refundID);
