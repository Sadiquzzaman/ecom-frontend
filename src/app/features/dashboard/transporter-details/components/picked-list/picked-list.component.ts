...
@Component({
  selector: 'app-picked-list',
  templateUrl: './picked-list.component.html',
  styleUrls: ['./picked-list.component.scss'],
})
export class PickedListComponent
  implements OnInit, AfterViewChecked, AfterViewInit
{
  ...
  delevered = (id: string, status: number) => {
    const statusDto = { status };
    this.dialogRef = this.dialog.open(ConfirmDialogComponent, {
      disableClose: false,
      data: {
        title: 'Have your delivered the items?',
