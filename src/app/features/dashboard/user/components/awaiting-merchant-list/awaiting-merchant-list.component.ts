...
@Component({
  selector: 'app-awaiting-merchant-list',
  templateUrl: './awaiting-merchant-list.component.html',
  styleUrls: ['./awaiting-merchant-list.component.scss'],
})
export class AwaitingMerchantListComponent implements AfterViewInit {
