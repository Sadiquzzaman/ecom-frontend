...
@Component({
  selector: 'app-merchant-approved-list',
  templateUrl: './merchant-approved-list.component.html',
  styleUrls: ['./merchant-approved-list.component.scss'],
})
export class MerchantApprovedListComponent implements AfterViewInit {
  ...
  updateStatus = () => {
    let dto = { ids: this.merchantIds, status: false };
