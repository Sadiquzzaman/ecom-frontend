...
@Injectable()
export class ShipmentChargeService {
  baseUrl = this.apiConfigService.getUrl(MicroserviceURL.ORDER) + `shipments`;
  ...
  pagination = (
    ...
    this._httpClient.get(
      `${this.baseUrl}/pagination?page=${page}&limit=${limit}&sort=${sort}&order=${order}&id=${id}`
    );

  createAttribute = (dto: any): Observable<any> =>
