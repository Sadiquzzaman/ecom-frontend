...
@Injectable()
export class ShipmentAttributeService {
  baseUrl =
    this.apiConfigService.getUrl(MicroserviceURL.ORDER) + `shipment-groups`;
  ...
  createShipmentAttributes = (dto: any): Observable<any> =>
