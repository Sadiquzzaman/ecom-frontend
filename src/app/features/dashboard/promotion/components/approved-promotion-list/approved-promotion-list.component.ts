...
@Component({
  selector: 'app-approved-promotion-list',
  templateUrl: './approved-promotion-list.component.html',
  styleUrls: ['./approved-promotion-list.component.scss'],
})
export class ApprovedPromotionListComponent
  implements AfterViewInit, AfterViewChecked
{
  ...
  updateStatus = () => {
    let dto = { ids: this.promotionIds, status: false };
