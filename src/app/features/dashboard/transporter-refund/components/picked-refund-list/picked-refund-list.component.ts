...
@Component({
  selector: 'app-picked-refund-list',
  templateUrl: './picked-refund-list.component.html',
  styleUrls: ['./picked-refund-list.component.scss'],
})
export class PickedRefundListComponent
